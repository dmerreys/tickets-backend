...
router.post('/preload', authMiddleware, async (req, res) => {
  console.log('Endpoint /api/services/preload alcanzado');
  ...
  const services = [
    // Basado en tus ejemplos y ajustado para ser realistas
  ...
  try {
    ...
    console.log('Insertando nuevos servicios:', services.length);
    const insertedServices = await Service.insertMany(services);
    console.log('Servicios insertados con éxito:', insertedServices.length);
...
router.get('/', authMiddleware, async (req, res) => {
  console.log('Endpoint /api/services/ alcanzado');
  try {
